...
\begin{abstract}
This document contains the proof for the problem based on Cayley-Hamilton Theorem.
\end{abstract}
Download latex-tikz codes from 
%
\begin{lstlisting}
https://github.com/EE20RESCH11008/Matrix-Theory/tree/master/Assignment-2
\end{lstlisting}
%
\section{Problem}
If A=\myvec{3 &1 \\ -1 &2 }, show that A^2-5A+7I = 0.
\section{Solution}
\begin{flushleft}
