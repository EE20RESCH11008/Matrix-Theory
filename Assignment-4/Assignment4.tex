...
\begin{align}
 c=\vec{n_1}^T \vec{q_1}
\end{align}
From the equations 2.1.1 and 2.1.3,
\begin{align}
...
\begin{align}
 c=\vec{n_2}^T \vec{q_2}
\end{align}
From the equations 2.2.1 and 2.2.3,
\begin{align}
...
\end{align}
\subsection{Result}
From the equations 2.1.9 and 2.2.9, normal vector of Tangent-1 and Tangent-2 are equal. \newline 
