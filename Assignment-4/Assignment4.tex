...
\begin{align}
 ...
 \end{align}
This vector $\vec{n_1}$ is normal to the tangent drawn at $\vec{q_1}$ 
\begin{align}
\vec{n_1}=\vec{q_1}+\vec{u}  
\end{align}
where, 
\begin{align}
\vec{c}=-\vec{u}  
...
\end{align}
If $\vec{q_1}$ be a point on the line and $\vec{n_1}$ is the normal vector, the equation of the line can be expressed as
\begin{align}
...
\begin{align}
 c=\vec{n_1}^T \vec{q_1}
\end{align}
From the equations 2.1.1 and 2.1.5,
\begin{align}
 \implies c=\myvec{\frac{1}{2} \hspace{10} \frac{1}{2}} \myvec{4\\3}= \frac{7}{2}
\end{align}
The line equation of Tangent-1 is:
\begin{align}
...
\end{align}
\subsection{Tangent-2} Let us take,
\begin{align}
\vec{q_2}=\myvec{3\\2}
\end{align}
...
\begin{align}
 ...
 \end{align}
This vector $\vec{n_2}$ is normal to the tangent drawn at $\vec{q_2}$
\begin{align}
\vec{n_2}=\vec{q_2}+\vec{u}
\end{align}
The normal vector to the line is obtained as 
\begin{align}
\vec{n_2}^T=\myvec{\frac{-1}{2} \hspace{10} \frac{-1}{2}}
\end{align}
If $\vec{q_2}$ be a point on the line and $\vec{n_2}$ is the normal vector, the equation of the line can be expressed as
\begin{align}
...
\begin{align}
 c=\vec{n_2}^T \vec{q_2}
\end{align}
From the equations 2.2.1 and 2.2.4,
\begin{align}
 \implies c=\myvec{\frac{-1}{2} \hspace{10} \frac{-1}{2}} \myvec{3\\2}= \frac{-5}{2}
\end{align}
The line equation of Tangent-2 is:
\begin{align}
...
\end{align}
\subsection{Result}
From the equations 2.1.11 and 2.2.10, normal vector of Tangent-1 and Tangent-2 are equal. \newline 
